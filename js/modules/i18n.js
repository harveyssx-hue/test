...
const TRANSLATIONS = {
    'en': {
        ...
        'auth_phone_placeholder': 'Enter phone number (e.g. 13999991234)',
        ...
        'home_sec_circulation': 'Circulation Feed',
        'market_cat_sector': 'Industry Sector',
        'profile_avail_trade_lbl': 'Available to trade',
        'home_feed_toast_updated': 'The circulation feed is already up to date',
        'home_feed_post1': 'Today\'s operation: Added position in the semiconductor sector. Portfolio returns broke 15%, keep watching me! The spring of tech stocks has arrived, persist in long-term holding, the leverage effect will gradually appear.',
        'home_feed_post2': 'Bought 50,000 chip shares, limit up yesterday, and it continues to skyrocket today.',
    ...
    'hi': {
        ...
        'auth_phone_placeholder': 'फ़ोन नंबर दर्ज करें',
        ...
        'home_sec_circulation': 'परिसंचरण फ़ीड',
        'market_cat_sector': 'उद्योग क्षेत्र',
        'profile_avail_trade_lbl': 'व्यापार के लिए उपलब्ध',
        'home_feed_toast_updated': 'परिसंचरण फ़ीड पहले से ही अद्यतित है',
        'home_feed_post1': 'आज का ऑपरेशन: सेमीकंडक्टर सेक्टर में पोजीशन जोड़ी। पोर्टफोलियो रिटर्न 15% को पार कर गया, मुझे देखते रहें! टेक शेयरों का वसंत आ गया है, लंबी अवधि के होल्डिंग पर बने रहें, लीवरेज प्रभाव धीरे-धीरे दिखाई देगा।',
        'home_feed_post2': 'कल 50,000 चिप शेयर खरीदे, कल लिमिट बढ़ गई थी, और आज यह आसमान छू रहा है।',
